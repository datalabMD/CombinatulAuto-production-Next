    ...
    <>
      <div className="parcare-auto-container10">
        <Head>
          ...
          <meta
            property="og:title"
            content="Parcare-Auto - SA Combinatul Auto Nr.4 din Chișinău"
          />
          <meta
        ...
        <main className="parcare-auto-main">
          <div id="transport" className="parcare-auto-hero section-container">
            <div className="parcare-auto-max-width1 max-content-container">
              <div className="parcare-auto-content-container">
                ...
                <div className="parcare-auto-btns-container">
                  <a
                    href="https://combinatulauto.md/#servicii"
                    target="_blank"
                    rel="noreferrer noopener"
                    className="parcare-auto-primary button-primary button-lg button"
                  >
                    servicii
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="parcare-auto-secondary button button-outline button-lg-border"
                  >
                    adresa noastra
                  </a>
                </div>
          ...
          <div className="parcare-auto-numbers-banner section-container">
            <div className="parcare-auto-container24 max-content-container">
              ...
              <div className="parcare-auto-numbers-container">
      ...
      <style jsx>
        {`
          ...
          .parcare-auto-primary {
            margin-right: var(--dl-space-space-oneandhalfunits);
            text-decoration: none;
          }
          .parcare-auto-secondary {
            text-decoration: none;
          }
          .parcare-auto-video-container {
            flex: 1;
            width: 200px;
            display: flex;
            align-items: flex-start;
          ...
          .parcare-auto-container18 {
            ...
            flex-direction: column;
            background-size: cover;
            background-image: url('/23-1200h.webp');
            background-repeat: no-repeat;
            background-position: left;
          }
