    ...
    <>
      <div className="anunt1-container1">
        ...
        <main className="anunt1-main">
          <div id="transport" className="anunt1-hero section-container">
            <div className="anunt1-max-width1 max-content-container">
              <div className="anunt1-content-container">
                ...
                <div className="anunt1-btns-container1">
                  <a
                    href="https://combinatulauto.md/#servicii"
                    target="_blank"
                    rel="noreferrer noopener"
                    className="anunt1-primary1 button-primary button-lg button"
                  >
                    servicii
                  </a>
                  <a
          ...
          <div className="anunt1-container3">
            <div className="anunt1-btns-container2">
              <Link href="/news">
                <a className="anunt1-link button-primary button-lg button">
          ...
          <div className="anunt1-numbers-banner section-container">
            <div className="anunt1-container4 max-content-container">
