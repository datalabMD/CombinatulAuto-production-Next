    ...
    <>
      <div className="reparatii-auto-container1">
        <Head>
          ...
          <meta
            property="og:title"
            content="Reparatii-Auto - SA Combinatul Auto Nr.4 din Chișinău"
          />
          <meta
        ...
        <main className="reparatii-auto-main">
              ...
              <div className="reparatii-auto-content-container1">
                ...
                <div className="reparatii-auto-btns-container1">
                  <a
                    ...
                    className="reparatii-auto-primary button-primary button-lg button"
                  >
                    servicii
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="reparatii-auto-secondary button button-outline button-lg-border"
                  >
                    adresa noastra
                  </a>
                </div>
              ...
              <div className="reparatii-auto-container4">
                ...
                <div className="reparatii-auto-container6">
                  ...
                  <div className="reparatii-auto-btns-container2">
                    ...
                    <a
                      href="#contacts"
                      className="reparatii-auto-learn-more button button-outline button-md-border"
                    >
                      adresa
                    </a>
                  </div>
          ...
          <div className="reparatii-auto-numbers-banner section-container">
            <div className="reparatii-auto-container7 max-content-container">
              ...
              <div className="reparatii-auto-numbers-container">
      ...
      <style jsx>
        {`
          ...
          .reparatii-auto-primary {
            margin-right: var(--dl-space-space-oneandhalfunits);
            text-decoration: none;
          }
          .reparatii-auto-secondary {
            text-decoration: none;
          }
          .reparatii-auto-video-container {
            flex: 1;
            width: 200px;
            display: flex;
            align-items: flex-start;
          ...
          .reparatii-auto-register {
            text-decoration: none;
          }
          .reparatii-auto-learn-more {
            color: var(--dl-color-scheme-white);
            transition: 0.3s;
            border-color: var(--dl-color-scheme-white);
            text-decoration: none;
          }
          .reparatii-auto-learn-more:hover {
            border-color: var(--dl-color-scheme-pink);
          }
          .reparatii-auto-numbers-banner {
            display: flex;
          ...
          .reparatii-auto-numbers-container {
            width: 100%;
            display: grid;
          ...
          .reparatii-auto-previous-events {
            display: flex;
            position: relative;
            flex-direction: column;
