    ...
    <>
      <div className="despre-noi-container1">
        <Head>
          ...
          <meta
            property="og:title"
            content="Despre-Noi - SA Combinatul Auto Nr.4 din Chișinău"
          />
          <meta
        ...
        <main className="despre-noi-main">
            ...
            <div className="despre-noi-max-width1 max-content-container">
              <div className="despre-noi-content-container1">
                ...
                <div className="despre-noi-btns-container1">
                  ...
                  <a
                    href="#contacts"
                    className="despre-noi-secondary button button-outline button-lg-border"
                  >
                    adresa noastra
                  </a>
                </div>
          ...
          <div className="despre-noi-speakers section-container">
            ...
            >
              ...
              <div className="despre-noi-speakers-container">
                <Link href="/transport">
                  <a>
                    <SpeakerCard
          ...
          <div className="despre-noi-numbers-banner section-container">
            <div className="despre-noi-container3 max-content-container">
              ...
              <div className="despre-noi-numbers-container">
          ...
          <div className="despre-noi-location">
            <img
              id="news"
              alt="image"
              src="/cars-1500w.webp"
              ...
              <div className="despre-noi-container4">
                ...
                <div className="despre-noi-container6">
                  ...
                  <div className="despre-noi-btns-container2">
                    ...
                    <a
                      href="#contacts"
                      className="despre-noi-learn-more button button-outline button-md-border"
                    >
                      adresa
                    </a>
                  </div>
      ...
      <style jsx>
        {`
          ...
          .despre-noi-secondary {
            text-decoration: none;
          }
          .despre-noi-video-container {
            flex: 1;
            width: 200px;
            display: flex;
            align-items: flex-start;
          ...
          .despre-noi-learn-more {
            color: var(--dl-color-scheme-white);
            transition: 0.3s;
            border-color: var(--dl-color-scheme-white);
            text-decoration: none;
          }
          .despre-noi-learn-more:hover {
